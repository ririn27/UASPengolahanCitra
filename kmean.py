...
# membaca gambar / foto
image = cv2.imread('image.jpg')  # ganti image sesuai dengan path ke file gambar Anda
...
pixel_values = image.reshape((-1, 1))  # 1 channel for grayscale
...
for i in range(k):
    ...
    masked_image = masked_image.reshape((-1, 1))  # 1 channel for grayscale
